	...
	; Compiler options:
	;
	; -oLeitura do controle 1.cof -mLeitura do controle 1.map \
	; --summary=default --output=default main.p1 --chip=16F628A \
	; -IC:\Program Files (x86)\HI-TECH Software\PICC\9.83\include\legacy -P \
